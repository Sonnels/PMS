...
@section('Contenido')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <span class="title_header">
                        Añadir Consumo a la Habitación N°:
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                ...
                <p>{{ SalidaController::fechaCastellano(date('Y-m-d', strtotime($reserva->departure_date))) }}
                    {{ date('H:i:s', strtotime($reserva->departure_date)) }}</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('consumo.update', $reserva->IdReserva) }}" method="post" id="form1">
        @csrf
        @method('PUT')
        <div class="form-group">
        ...
        <div class="row">
            <div class="col-12 text-center" style="margin-top: 20px">
                <a href="{{ asset('ventas/consumo') }}" class="btn btn-danger">Volver</a>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function agregar() {
                ...
                if (cantidad == "") {
                    alert("Ingrese la cantidad de productos a vender.")
                    return 0;
                }
            ...
            function eliminar(index) {
             ...
             document.querySelector('#form1').addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    // confirmButtonColor: '#36BE80',
                    title: 'Necesitamos de tu confirmación!',
                    text: '¿Desea continuar el registro de consumo?',
                    confirmButtonText: `Sí, Adelante!`,
