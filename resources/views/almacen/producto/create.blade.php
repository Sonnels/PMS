...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <span class="title_header">Agregando Nuevo Producto</span>
            </div>
            <div class="col-sm-6">
...
<div class="row" id="formulario">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<input type="number" name="stock"  value="{{old('stock')}}" class="form-control" placeholder="Ingrese el stock del Producto" required>
		</div>
	</div>
</div>
<div class="form-group">
